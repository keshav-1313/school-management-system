...
router.post("/", protect, authorizeRoles("admin", "teacher"), createTimetableSlot);
...
router.put("/:id", protect, authorizeRoles("admin", "teacher"), updateTimetableSlot);
router.delete("/:id", protect, authorizeRoles("admin", "teacher"), deleteTimetableSlot);
